        ...
        while Verdad == True:
            ...
            def watch_coin():
                ...
                if  float(open_price) == trade:
                    print(f" STOP STOP STOP your sell price is {trade} the {trade_coin} price is {Fore.green}{open_price}")
                    sell_coin()
                                #rgb(255,140,0) dark orange
                else: print(f" {Fore.rgb(255, 140, 0)}NOT READY your STOP LOSS price is {Fore.rgb(0, 128, 0)}{trade} {Fore.white}the {trade_coin} price is {Fore.red}{open_price}")
